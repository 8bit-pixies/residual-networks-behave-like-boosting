...
path = "clean_data"
train_adult = pd.read_csv(path+'/sat_train_scale.csv')
test_adult = pd.read_csv(path+'/sat_test_scale.csv')

x, y = split_pred(train_adult, "X37")
x_test, y_test = split_pred(test_adult, "X37")
y = to_categorical(y)
y_test = to_categorical(y_test)

save_dir = os.path.join(os.getcwd(), 'saved_models')
save_dir = "sat_benchmark"
model_name = 'sat_model_rf_share5.{epoch:03d}.h5'
