...
path = "clean_data"
train_adult = pd.read_csv(path+'/covtype_train_scale.csv')
test_adult = pd.read_csv(path+'/covtype_test_scale.csv')

x, y = split_pred(train_adult, "X55")
x_test, y_test = split_pred(test_adult, "X55")
y = to_categorical(y)
y_test = to_categorical(y_test)

save_dir = os.path.join(os.getcwd(), 'saved_models')
save_dir = "covtype_benchmark"
