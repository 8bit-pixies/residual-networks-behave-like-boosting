...
path = "clean_data"
train_adult = pd.read_csv(path+'/simplemandelon_train.csv')
test_adult = pd.read_csv(path+'/simplemandelon_test.csv')

x, y = split_pred(train_adult, "y")
x_test, y_test = split_pred(test_adult, "y")
y = to_categorical(y)
y_test = to_categorical(y_test)

save_dir = os.path.join(os.getcwd(), 'saved_models')
save_dir = "simplemandelon_benchmark"
model_name = 'simplemandelon_model_gbm_share15.{epoch:03d}.h5'
